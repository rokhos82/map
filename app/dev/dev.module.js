...
import {componentBuilderNew} from "./componentBuilderNew.component.js";
...
function devModuleController($uiRouter) {
  ...
  $stateRegistry.register(devComponentBuilderNewState);
}
...
DEV_MODULE.component("componentBuilderNew",componentBuilderNew);
